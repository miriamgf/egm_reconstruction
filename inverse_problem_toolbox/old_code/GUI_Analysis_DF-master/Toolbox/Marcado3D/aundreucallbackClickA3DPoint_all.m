function pointCloudIndex=aundreucallbackClickA3DPoint_all(pointCloud,figure_used,node_selected)
...
if isempty(node_selected)
    ginput(1);
    figure(figure_used);
    set(0, 'CurrentFigure', figure_used)
...
% if it's the first click (i.e. no previous point to delete)
hold on,
