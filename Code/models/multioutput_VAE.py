...
class MultiOutput_VAE(Model):
    ...
    def __init__(
        ...
        self.conv3d_2 = layers.Conv3D(
            ...
            padding="same",
            activation="leaky_relu",
            kernel_regularizer=tf.keras.regularizers.l2(self.params["l2_reg_rec_2"]),
        )
    ...
    def train_step(self, data):
        ...
        # Unpack data
        x, (y_true_autoencoder, y_true_regressor) = (
            data  # Assuming data is in the form (x, (y1, y2))
        )
