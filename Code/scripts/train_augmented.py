...
import os
os.environ["XLA_FLAGS"] = "--xla_gpu_cuda_data_dir=/home/pdi/miriamgf/cuda-fake"
import gc
...
from tools_.data_augmentation_loader import LoadSyntheticDataset
...
data_gen_dir = "/home/profes/miriamgf/tesis/Autoencoders/Data_generated/"
...
# Después de cargar el dataset real
...
for name in [
    ...
    "Y","synt_Y_model", "Y_model","synt_egm_tensor",
    "egm_tensor","synt_length_list",
    "synt_AF_models", "AF_models",
    "synt_all_model_names","synt_transfer_matrices",
    "synt_y_list",
    "synt_class_complexity_list"
]:
    if name in locals():
