...
def plot_1D_signals(tikhonov_signal, tikhonov_label,
                    dl_signal, dl_label, node = 0,
                    torso = None, n_samples= 500,
                    normalize_tik = False,
...
def plot_correlation_by_models(range_of_models=None, type_corr = 'Pearson', separation= 0.3, rotation=45, experiment=None):
   ...
   #Boxplot 2
    ...
    plt.legend([boxplots_tk["boxes"][0], boxplots_dl["boxes"][0]], ['Tikhonov', 'DL'], loc='best')
    plt.tight_layout()
    plt.show()
