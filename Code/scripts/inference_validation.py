...
egm = load_EGM(SR=True, subsampling=True, fs_sub=100, n_nodes_regression=683)

# Interpolate

bsps = load_BSPS(subsampling=True, fs_sub=100, batch_size=batch_size)
...
(global_loss_test, mse_test_ae, mse_test_regressor, mae_test_ae, mae_test_regressor) = (
    model.evaluate(bsps_batches, [bsps_batches, egm_batches], batch_size=1)
)
