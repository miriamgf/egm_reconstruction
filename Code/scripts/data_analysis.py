...
signals_array_reshaped_flattened = signals_array_reshaped.reshape(76, -1)
...
df_parejas_correlacion = pd.DataFrame(parejas_correlacion, columns=['Señal 1', 'Señal 2', 'Correlación'])
...
df_parejas_correlacion.to_csv('output/figures/'+'parejas_correlacion.csv', index=False)
