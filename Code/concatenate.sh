...
a = np.load('Gen_VAE_2D_v2_develop_cond_class4_vae_cond_guided.npy', mmap_mode='r')
b = np.load('Gen_VAE_2D_v2_develop_cond_class2_vae_cond_guided.npy', mmap_mode='r')
c = np.concatenate([a, b], axis=0)   # (50, 400, 2048)

out = pathlib.Path('Gen_VAE_2D_v2_develop_cond_class2_4_vae_guided.npy').resolve()
