...
def DF_mapping(y_test, pred_test, BSPM_test, AF_models_test, path_save, norm=True):
    ...
    direct = path_save + "DF_Mapping_variables/"

    os.makedirs(direct)

    # savemat(dict_var_dir + "DF_Mapping_variables/" +'DF_Mapping_'+ str(model) + ".mat", dic_DF)
    savemat(direct + "DF_Mapping_" + str(model) + ".mat", dic_DF)
