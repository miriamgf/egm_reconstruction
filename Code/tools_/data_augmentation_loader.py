...
class LoadSyntheticDataset:
    ...
    def load_data(
        ...
        for model_name, model_class in zip(all_model_names, all_model_classes): 
            ...
            egms = self.load_egms_arrays(model_name)
            ...
            for matrix in transfer_matrices:
                ...
                if not self.classification:
                    ...
                    Y_model.extend(y_model)
                    y_list.append({'y': y, 'matrix_num': matrix_num}) #save full bsp and matrix number
    ...
    def load_egms_arrays(self, model_name):
        """
        Load electrograms from numpy arrays, each one row
        ...
        return self.synthetic_egms[idx].T
