...
nohup python -u scripts/evaluation/evaluate_main.py --algorithm_ID 'OMAMI_no_filt_testing2' --ev_DL false --ev_TIK true > output/logs/evaluation/OMAMI_no_filt_testing2.log 2>&1 
#wait
